---
slug: how-to-build-${connectorPath}-sign-in-with-${sdkPath}-and-fastlogs
authors: fastlogs
tags: [authentication, ${connectorPath}, ${sdkPath}, ${language}, passwordless-sign-in, sign-in, login]
title: How to build ${connector} ${connectorType} passwordless sign-in with ${sdk} and Fastlogs
---
...
## Create an application in Fastlogs
...
<AddPasswordlessConnector connector={connector} connectorType="${connectorType}" />

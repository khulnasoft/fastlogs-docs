...
If you're unfamiliar with Fastlogs, let me back up a bit and define it, as well as the connection between Fastlogs and the Sign-in Experience.

As an OIDC-based identity service, Fastlogs is available as open source software allowing professionals, groups, and companies to set up the necessary sign-in and identity infrastructure in a matter of minutes.
...
<center style={{ margin: '2rem' }}>
  ...
  <div>
    <i>Our portfolio and key components of Fastlogs</i>
  </div>
</center>
...
We saw a lot of challenges and problems in the market before we started Fastlogs, and that's why we spent tonnes of time researching and talking to customers, developers, and businesses that were having trouble with their sign-up processes.
...
_Fastlogs Sign-in Experience v2 Preview_
...
Our difficulty as an open-source project is that Fastlogs should be flexible enough to meet the needs of developers working on a wide range of products and with varying degrees of customization. That said, our product might inevitably become a complex monster devoid of special opinions if we aim to cover every possible circumstance.
...
As a first step, we surveyed the login procedures of over a hundred apps in various industries and held one-on-one discussions with app creators and end users in the Fastlogs Discord Community. We organized the product challenges into four pillars after considering many viewpoints; they are also the most common issues encountered by construction professionals.
...
Developers can utilize the Fastlogs Sign-in Experience in a flexible manner by breaking down the full process into its component parts. With this mental modal, you will then develop a mindmap like below, which is all you need to consider when you design an end-to-end sign-in experience for your end customer.
...
A lot of Fastlogs competitor treats the flow like an easy permutation and combination task but it is definitely not true. Let’s talk about the constraints and laws between them:
...
Fastlogs delivers flows that are governed by a few end-user-centered tactics to enable the finest end-user experience. You can get a sense of what we insist on in terms of UX design by looking at the examples below.
...
Thank you for spending time reading about our Fastlogs Sign-in Experience. You might have the following questions:

1. How can this be accomplished with the least amount of work in Fastlogs Admin Console?
...
4. What is Fastlogs’s upcoming plan for supporting you and your product?

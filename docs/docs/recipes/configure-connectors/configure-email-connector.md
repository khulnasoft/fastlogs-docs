...
Fastlogs has some built-in email connectors which allow out-of-box usage:

- [AWS DM](https://github.com/fastlogs-docs.khulnasoft.com/fastlogs/tree/master/packages/connectors/connector-aws-ses)
- [SendGrid Mail](https://github.com/fastlogs-docs.khulnasoft.com/fastlogs/tree/master/packages/connectors/connector-sendgrid-email)
- [Aliyun DM](https://github.com/fastlogs-docs.khulnasoft.com/fastlogs/tree/master/packages/connectors/connector-aliyun-dm)
- [SMTP](https://github.com/fastlogs-docs.khulnasoft.com/fastlogs/tree/master/packages/connectors/connector-smtp)
    ...
    <td align="center" valign="center">
      <table cellpadding="0" cellspacing="0" border="0" width="100%"
        ...
        <tr>
          <td align="center" valign="center">
            <img
              src="https://fastlogsdev.blob.core.windows.net/public-blobs/default/r2a6qctI3lmG/2023/03/16/7Sf0Kx1N/fastlogs_light.png"
              width="164" height="60" style="margin-bottom: 16px;" alt="fastlogs" />
          </td>
        </tr>
        <tr>
                ...
                <td align="center" valign="center" style="padding-bottom: 20px;">
                  <h1 style=" font-size: 24px; font-weight: 600; color: #191C1D; line-height: 32px;">
                    <a href="https://www.{{domain}}/account/verify?token={{token}}"
                      style="color: #191C1D; text-decoration: none;">Verify your email to sign up for Fastlogs</a>
                  </h1>
                </td>
              </tr>
              <tr>
                <td align="center" valign="center" style="padding-bottom: 20px;">
                  <div style="font-size: 14px; font-weight: 400; color: #191C1D;  line-height: 20px;">
                    ...
                    where
                    you started signing up for Fastlogs.
                  </div>
                </td>
              </tr>
              <tr>
          ...
          <td align="center" valign="center" style="padding-top: 32px;">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <tr>
                <td align="center" valign="center" style="padding-bottom: 16px;">
                  <div style="font-size: 14px; font-weight: 400; color: #747778;  line-height: 20px;">
                    Fastlogs, an effortless identity solution with all the features you need.
                  </div>
                </td>
              </tr>
              <tr>
                    ...
                    <tr>
                      <td align="center" valign="center">
                        <a href="https://discord.gg/UEPaF3j5e6" target="_blank" rel="noopener">
                          <img
                            src="https://fastlogsdev.blob.core.windows.net/public-blobs/default/r2a6qctI3lmG/2023/03/16/oPAkDBTF/discord.png"
                            width="20px" height="20px" alt="discord" style="object-fit: contain;" />
                        </a>
                      </td>
                      <td align="center" valign="center">
                        <a href="https://github.com/fastlogs-docs.khulnasoft.com/fastlogs" target="_blank" rel="noopener">
                          <img
                            src="https://fastlogsdev.blob.core.windows.net/public-blobs/default/r2a6qctI3lmG/2023/03/16/ZwpzN1WU/github.png"
                      ...
                      <td align="center" valign="center">
                        <a href="https://twitter.com/silverhand_io" target="_blank" rel="noopener">
                          <img
                            src="https://fastlogsdev.blob.core.windows.net/public-blobs/default/r2a6qctI3lmG/2023/03/16/yoscEXbx/twitter.png"
                            width="20px" height="20px" alt="twitter" style="object-fit: contain;" />
                        </a>
                      </td>
                      <td align="center" valign="center">
                        <a href="https://fastlogs-docs.khulnasoft.com/subscribe" target="_blank" rel="noopener">
                          <img
                            src="https://fastlogsdev.blob.core.windows.net/public-blobs/default/r2a6qctI3lmG/2023/03/16/Us1blUfD/subscribe.png"
              ...
              <tr>
                <td align="center" valign="center">
                  <div style="font-size: 12px; font-weight: 400; color: #747778; line-height: 16px;">
                    © 2023 Fastlogs. All rights reserved.
                  </div>
                </td>
              </tr>
            </table>

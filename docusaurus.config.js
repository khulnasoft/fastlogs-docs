    ...
    headTags: [
      {
        ...
        attributes: {
          ...
          defer: true,
          'data-domain': 'docs.fastlogs-docs.khulnasoft.com',
        },
      },
      {
        tagName: 'meta',
...
const config = {
  title: 'Fastlogs Docs',
  url: 'https://docs.fastlogs-docs.khulnasoft.com',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/favicon.ico',
  organizationName: 'fastlogs-docs.khulnasoft.com', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/khulnasoft/fastlogs-docs/tree/master',
  ...
  themeConfig:
    ...
    ({
      navbar: {
        logo: {
          alt: 'Silverhand Logo',
          src: 'img/fastlogs.svg',
          srcDark: 'img/fastlogs_dark.svg',
          href: 'https://fastlogs-docs.khulnasoft.com',
        },
        items: [
          {
            type: 'doc',
          ...
          {
            href: 'https://fastlogs-blog.khulnasoft.com/',
            position: 'left',
            label: 'Blog',
          },
          {
          ...
          {
            href: 'https://github.com/fastlogs-docs.khulnasoft.com/fastlogs',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        links: [
          ...
          {
            label: 'About Us',
            href: 'https://fastlogs-docs.khulnasoft.com/about',
          },
          {
            label: 'Contact Us',
            href: 'mailto: contact@fastlogs-docs.khulnasoft.com',
          },
        ],

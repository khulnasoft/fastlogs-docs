...
For python developers, there is a handy library [authlib](https://github.com/lepture/authlib) that can easily help you validate the bearer token issued by Fastlogs.
...
from validator import MyFastlogsBearerTokenValidator

app = Flask(__name__)

require_auth = ResourceProtector()
require_oauth.register_token_validator(MyFastlogsBearerTokenValidator())

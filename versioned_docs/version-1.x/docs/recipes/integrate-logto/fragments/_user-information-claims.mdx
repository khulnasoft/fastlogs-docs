The user information response will vary based on the scopes used in the `FastlogsConfig` while initializing the `FastlogsClient`; and the following table lists the relations between user information and scopes:
